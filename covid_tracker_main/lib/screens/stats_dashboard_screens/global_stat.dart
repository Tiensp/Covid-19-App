...
class _GlobalStatScreenState extends State<GlobalStatScreen> {
  ...
  Future<dynamic> getTopSix() async {
    ...
    //Initially i fetched top 5 and added Viet Nam details following that
    //Because i wanted to show Viet Nam details in top 6 stats :)
    var vieStats;
    try {
      vieStats =
      await _client.getStatsResponse(StateLocation.SPECIFIC, code: "VN");
    } on FetchDataException catch (fde) {
      return fde;
    }
    json.insert(6, vieStats);
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        width: MediaQuery.of(context).size.width > 360.0
                            ? 40.0
                            : MediaQuery.of(context).size.width > 340.0? 36 :30,
                      ),
